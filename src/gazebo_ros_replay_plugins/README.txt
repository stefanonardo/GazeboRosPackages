...
Playback Plugin (gazebo_ros_playback_plugin)
----------------------------------------------

The following service calls are provided:

	- /gazebo/playback/configure - Configure the playback plugin and load the first
                                 set of logs to play, all other commands are
                                 available after this is run.

	- /gazebo/playback/start - Start recording playback, loop all files.

	- /gazebo/playback/pause - Pause recording playback, save current state.

	- /gazebo/playback/stop - Stop recording playback, discards state.

	- /gazebo/playback/reset - Discard state and reload first log files.

The playback plugin will loop through all recordings generated by the recording
plugin, starting the first again after completion of the last.
